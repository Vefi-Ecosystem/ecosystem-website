...
// Source: https://github.com/vercel/next.js/blob/canary/examples/active-class-name/components/ActiveLink.js
export const ActiveLink = ({ children, activeClassName, ...props }: any) => {
